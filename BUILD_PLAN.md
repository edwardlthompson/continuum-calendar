...
- ✅ [HUMAN] Attach desktop installer / Android APK to GitHub Release (v0.23.0: EXE 0.17.3 + APK 1.10.7 copied from v0.22.1)
- ✅ [AUTO] Triage Dependabot medium `glib` in `apps/desktop/src-tauri/Cargo.lock` (do not bump to 0.20 — GTK4) — deferred 2026-08-20
- ✅ [AUTO] Confirm v0.23.0 GitHub Release has SBOMs + product binaries (2026-08-21 `/ship`)
