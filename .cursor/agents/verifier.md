...
3. If this is the last open AGENT/AUTO row in the sprint, require `python3 scripts/agent-run.py smoke-sprint --require` before the orchestrator starts the next sprint.
4. Report pass/fail with evidence (command output tail only).
