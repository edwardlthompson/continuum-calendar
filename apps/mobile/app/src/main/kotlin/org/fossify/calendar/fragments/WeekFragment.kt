                ...
                do {
                    ...
                    WeekEventMarkerBinding.inflate(layoutInflater).apply {
                        ...
                        if (hasScheduleConflict) {
                            // Amber edge so conflicts stay eye-catching next to calendar colors.
                            root.setBackgroundColor(0xFFCA8A04.toInt())
                            weekEventLabel.setTextColor(0xFF1C1917.toInt())
                            if (event.isTask()) {
                                weekEventTaskImage.applyColorFilter(0xFF1C1917.toInt())
                            }
                        }
