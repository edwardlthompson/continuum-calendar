...
class EventListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyRecyclerViewAdapter.ViewHolder {
        ...
        val root = when (viewType) {
            ...
            ITEM_NOW_MARKER -> ItemNowMarkerBinding.inflate(layoutInflater, parent, false).root
    ...
    override fun onBindViewHolder(holder: MyRecyclerViewAdapter.ViewHolder, position: Int) {
        ...
        val allowClick = listItem is ListEvent
        holder.bindView(
            listItem,
            allowSingleClick = allowClick,
            allowLongClick = allowLongClick && allowClick,
        ) { itemView, _ ->
            when (listItem) {
    ...
    fun updateListItems(newListItems: ArrayList<ListItem>) {
        if (newListItems.hashCode() != currentItemsHash) {
            ...
            conflictIds = ContinuumConflict.conflictingListEventIds(listItems.filterIsInstance<ListEvent>())
