...
class Config(context: Context) : BaseConfig(context) {
    ...
    var startWeekWithCurrentDay: Boolean
        get() = prefs.getBoolean(START_WEEK_WITH_CURRENT_DAY, true)
        set(startWeekWithCurrentDay) = prefs.edit()
            .putBoolean(START_WEEK_WITH_CURRENT_DAY, startWeekWithCurrentDay).apply()

    var showEmptyDaysInAgenda: Boolean
        get() = prefs.getBoolean(SHOW_EMPTY_DAYS_IN_AGENDA, true)
        set(showEmptyDaysInAgenda) = prefs.edit()
            .putBoolean(SHOW_EMPTY_DAYS_IN_AGENDA, showEmptyDaysInAgenda).apply()

    var redactTitlesInScreenshots: Boolean
        get() = prefs.getBoolean(REDACT_TITLES_IN_SCREENSHOTS, false)
        set(redactTitlesInScreenshots) = prefs.edit()
            .putBoolean(REDACT_TITLES_IN_SCREENSHOTS, redactTitlesInScreenshots).apply()

    var rollingWeekWidget: Boolean
        get() = prefs.getBoolean(ROLLING_WEEK_WIDGET, true)
        set(rollingWeekWidget) = prefs.edit()
            .putBoolean(ROLLING_WEEK_WIDGET, rollingWeekWidget).apply()

    var showContactBirthdays: Boolean
        get() = prefs.getBoolean(SHOW_CONTACT_BIRTHDAYS, true)
        set(showContactBirthdays) = prefs.edit()
            .putBoolean(SHOW_CONTACT_BIRTHDAYS, showContactBirthdays).apply()
    ...
    var storedView: Int
        get() = prefs.getInt(VIEW, EVENTS_LIST_VIEW)
    ...
    var listWidgetViewToOpen: Int
        get() = prefs.getInt(LIST_WIDGET_VIEW_TO_OPEN, EVENTS_LIST_VIEW)
